...
Note: Inputs are rounded before checking if they are in the range for conversion to scientific format; e.g., $99999$ will be rounded to $1 \times 10^5$, so if the cutoff is $1 \times 10^5$, it will get converted to scientific format. 
